...
public class CustomColors {
    ...
    public static final Color darkViolet = new Color(54, 33, 89);
    public static final Color betweenViolet = new Color(85, 65, 118);
    ...
    public static final Color ordersFilterTextSelected = white;
    public static final Color ordersFilterTextUnselected = white;
